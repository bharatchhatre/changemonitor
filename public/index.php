...
foreach ($monitors as $m) {
    if (($m['status'] ?? 'active') === 'active') $activeCount++;
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-pane" id="tab-monitors">
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title">Active Monitored Targets</div>
                            ...
                            <?php if (empty($monitors)): ?>
                                <tr>
                                    <td colspan="7" style="text-align: center; color: var(--text-muted); padding: 3rem 1rem;">
                                        No targets configured yet. Click <strong>"+ Add Target"</strong> above to start monitoring!
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($monitors as $id => $m): ?>
                                    <tr>
                                        <td>
